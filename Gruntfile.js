...
module.exports = function( grunt ) {
	...
	grunt.config.init( {
		...
		checktextdomain: {
			standard: {
				options: {
					text_domain: [ 'uncr-translate' ], //Specify allowed domain(s)
		...
		makepot: {
	        target: {
	            options: {
	                ...
	                mainFile: 'recaptcha.php',                     // Main project file.
	                potComments: '',                  // The copyright at the beginning of the POT file.
	                potFilename: 'uber-nocaptcha-recaptcha.po',                  // Name of the POT file.
	                potHeaders: {
